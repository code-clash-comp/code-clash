...
(async function(){
  ...
  function renderTeamsList(){
    ...
    allTeams.forEach(team=>{
      ...
      if(team.captainUid){
        const cap = document.createElement('span'); cap.className='crown'; cap.textContent='👑'; cap.title='Captain';
      ...
      leaveBtn.onclick = async (ev)=> {
        ...
        if(team.captainUid === currentUser.uid){ alert("You're the captain — transfer or disband to leave."); return; }
